          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex flex-1 justify-center space-x-10">
              ...
              <Link
                ...
                className={linkClass("/planning", "tab=budget")}
              >
                Budget
                <span
                  className={indicatorClass("/planning", "tab=budget")}
                ></span>
              </Link>
              <Link
                to="/planning?tab=goal"
                className={linkClass("/planning", "tab=goal")}
              >
                Goal
                <span
                  className={indicatorClass("/planning", "tab=goal")}
                ></span>
              </Link>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <span className="hidden sm:block text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">
                  {user?.name}
                </span>
                <button
                  onClick={logout}
