              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    required
                    className="appearance-none block w-full px-4 py-3 border border-gray-700 rounded-xl bg-gray-900 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder:text-gray-600"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex justify-center py-3 px-4 border border-gray-700 rounded-xl shadow-sm text-sm font-bold text-gray-300 bg-gray-800 hover:bg-gray-700 transition-all"
              >
