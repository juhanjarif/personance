                ...
                <div className="p-8 rounded-3xl bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-700/50 shadow-sm relative overflow-hidden">
                    ...
                    {loans.length === 0 ? (
                        <div className="text-center py-6">
                            ...
                            <Link to="/loans" className="inline-block px-6 py-2 rounded-xl bg-amber-100/50 text-amber-700 font-bold text-xs">Add Loan &rarr;</Link>
                        </div>
                    ) : (
                        <div className="space-y-4">
                            {loans.map(loan => (
                                <Link key={loan.loan_id} to="/loans" className="block p-4 rounded-xl bg-white dark:bg-gray-800 border border-amber-100 dark:border-amber-900/30 hover:shadow-lg hover:shadow-amber-500/10 transition-all group">
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <div className="text-right">
                                            <p className="text-xs font-black text-gray-900 dark:text-white">Tk. {Number(loan.principal_amount).toLocaleString()}</p>
                                            <p className="text-[10px] font-bold text-amber-500">{loan.interest_rate}% Interest</p>
                                        </div>
                                    </div>
                                    <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-1.5 overflow-hidden">
                                        <div className="bg-amber-400 h-1.5 rounded-full w-1/3"></div>
                                    </div>
