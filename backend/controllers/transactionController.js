...
const createTransaction = async (req, res) => {
  const { accountId, categoryId, amount, type, description, toAccountId, toCategoryId } = req.body;
  ...
  try {
    if (type === 'transfer') {
        ...
        const transaction = await transactionModel.createTransaction(userId, accountId, categoryId, amount, type, description);
